        ...
        <div className="container">
          <div className="row align-items-center pt-5">
            <div className="col-12 col-md-9">
              ...
              <div className="mb-3">
                <h2 className="redtitle" style={{ fontWeight: 500 }}>{t('business.business_title')}</h2>
                <h1 className="redtitle hero-heading display-3 ">{t('business.sign_up')}</h1>
              </div>
              <div className="spacingsmall"></div>
                  ...
                  <form action="#" method="post">
                    <div className="row">
                      <div className="col-12 col-md-6 mb-4">
                        <label htmlFor="fname" className="text-light fw-bold">{t('business.first_name')}</label>
                        <input type="text" id="fname" className="form-control formcurve" />
                      </div>
                      <div className="col-12 col-md-6 mb-4">
                        <label htmlFor="lname" className="text-light fw-bold">{t('business.last_name')}</label>
                        <input type="password" id="lname" className="form-control formcurve" />
                      </div>
                      <div className="col-12 mb-4">
                        <label htmlFor="Email" className="text-light fw-bold">{t('business.email')}</label>
                        <input type="email" id="Email" className="form-control formcurve" />
                      </div>
                      <div className="col-12 col-md-6 mb-4">
                        <label htmlFor="password" className="text-light fw-bold">{t('business.password')}</label>
                        <input type="text" id="password" className="form-control formcurve" />
                      </div>
                      <div className="col-12 col-md-6 mb-4">
                        <label htmlFor="password-confirm" className="text-light fw-bold">{t('business.email')}</label>
