    ...
    <>
      ...
      <div className="action">
        <Stack gap={3} direction="horizontal">
          <Button
            className="zippy-btn zippy-flat d-flex w-full center simple"
            onClick={() => navigate('/my-wallet/status')}
          >
            Back
          </Button>
          <Button
            className="zippy-btn d-flex ms-auto w-full center simple"
